...
public class RoadTrip {
    public static void main(String[] args){
        ...
        double legDistance; // declaring this variable but not initizliaing it
        
        // simulation of the roadtrip
        System.out.println("***Road trip simulator***");
        // print out initial stats
        System.out.println("--> Beginning of trips stats<--");
        ...
        System.out.println("Desination Reached? " + destinationReached);
        System.out.println("********************");
        ...
        System.out.println("Oh, lok! A person who wants to go west, too!");
        ...
        if(carFull == false) {
            ...
            // alternative shorter verision: currentNumberOfPassengers++
